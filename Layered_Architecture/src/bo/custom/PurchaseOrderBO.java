...
public interface PurchaseOrderBO extends SuperBO {
     ...
     ArrayList<CustomerDTO> gerAllCustomers() throws SQLException, ClassNotFoundException;

     ArrayList<ItemDTO> gerAllItem() throws SQLException, ClassNotFoundException;
}
